...
const (
	...
	FieldBody = "body"
	// FieldSeverityStr holds the string denoting the severity_str field in the database.
	FieldSeverityStr = "severity_str"
...
var (
	...
	// SeverityStrValidator is a validator for the "severity_str" field. It is called by the builders before save.
	SeverityStrValidator func(string) error
...
// BySeverityStr orders the results by the severity_str field.
func BySeverityStr(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSeverityStr, opts...).ToFunc()
}
