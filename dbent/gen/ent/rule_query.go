...
func (_q *RuleQuery) Modify(modifiers ...func(s *sql.Selector)) *RuleSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *RuleSelect) Modify(modifiers ...func(s *sql.Selector)) *RuleSelect {
