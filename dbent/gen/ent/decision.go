...
func (*Decision) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case decision.FieldTrustScore, decision.FieldConfidence:
			values[i] = new(sql.NullFloat64)
		case decision.FieldID, decision.FieldSourceKind, decision.FieldSourceRef, decision.FieldProjectID, decision.FieldRepoID, decision.FieldTitle, decision.FieldBody, decision.FieldStatus, decision.FieldSupersededByID, decision.FieldCreatedByActorID:
			values[i] = new(sql.NullString)
		case decision.FieldCreatedAt, decision.FieldUpdatedAt, decision.FieldLastAccessedAt, decision.FieldLastValidatedAt, decision.FieldArchivedAt:
...
func (_m *Decision) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case decision.FieldLastAccessedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
		...
		case decision.FieldLastValidatedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
		...
		case decision.FieldProjectID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field project_id", values[i])
			} else if value.Valid {
				_m.ProjectID = value.String
			}
		case decision.FieldRepoID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case decision.FieldTitle:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field title", values[i])
			} else if value.Valid {
				_m.Title = value.String
			}
		case decision.FieldBody:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field body", values[i])
			} else if value.Valid {
				_m.Body = value.String
			}
		case decision.FieldStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field status", values[i])
			} else if value.Valid {
				_m.Status = decision.Status(value.String)
			}
		case decision.FieldSupersededByID:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case decision.FieldCreatedByActorID:
			if value, ok := values[i].(*sql.NullString); !ok {
