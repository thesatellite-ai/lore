...
const (
	// Label holds the string label denoting the externalsource type in the database.
	...
	// Table holds the table name of the externalsource in the database.
	Table = "external_sources"
)

// Columns holds all SQL columns for externalsource fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	// ConfigJSONValidator is a validator for the "config_json" field. It is called by the builders before save.
	ConfigJSONValidator func(string) error
...
// OrderOption defines the ordering options for the ExternalSource queries.
