...
type DecisionQuery struct {
	...
	loadTotal  []func(context.Context, []*Decision) error
...
func (_q *DecisionQuery) Modify(modifiers ...func(s *sql.Selector)) *DecisionSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *DecisionSelect) Modify(modifiers ...func(s *sql.Selector)) *DecisionSelect {
