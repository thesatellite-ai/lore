...
func (_c *ProjectCreate) SetOriginURL(v string) *ProjectCreate {
	_c.mutation.SetOriginURL(v)
	return _c
}

// SetNillableOriginURL sets the "origin_url" field if the given value is not nil.
func (_c *ProjectCreate) SetNillableOriginURL(v *string) *ProjectCreate {
	if v != nil {
		_c.SetOriginURL(*v)
	}
	return _c
...
func (_c *ProjectCreate) SetLastActiveAt(v time.Time) *ProjectCreate {
	_c.mutation.SetLastActiveAt(v)
	return _c
}

// SetNillableLastActiveAt sets the "last_active_at" field if the given value is not nil.
func (_c *ProjectCreate) SetNillableLastActiveAt(v *time.Time) *ProjectCreate {
	if v != nil {
...
func (_c *ProjectCreate) AddRepoIDs(ids ...string) *ProjectCreate {
	_c.mutation.AddRepoIDs(ids...)
	return _c
}

// AddRepos adds the "repos" edges to the Repo entity.
func (_c *ProjectCreate) AddRepos(v ...*Repo) *ProjectCreate {
...
func (_c *ProjectCreate) AddMemoryIDs(ids ...string) *ProjectCreate {
	_c.mutation.AddMemoryIDs(ids...)
	return _c
}

// AddMemories adds the "memories" edges to the Memory entity.
func (_c *ProjectCreate) AddMemories(v ...*Memory) *ProjectCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *ProjectCreate) check() error {
	...
	if _, ok := _c.mutation.LastActiveAt(); !ok {
		return &ValidationError{Name: "last_active_at", err: errors.New(`ent: missing required field "Project.last_active_at"`)}
	}
...
// SetOriginURL sets the "origin_url" field.
func (u *ProjectUpsert) SetOriginURL(v string) *ProjectUpsert {
	u.Set(project.FieldOriginURL, v)
	return u
}

// UpdateOriginURL sets the "origin_url" field to the value that was provided on create.
func (u *ProjectUpsert) UpdateOriginURL() *ProjectUpsert {
	u.SetExcluded(project.FieldOriginURL)
	return u
}

// ClearOriginURL clears the value of the "origin_url" field.
func (u *ProjectUpsert) ClearOriginURL() *ProjectUpsert {
	u.SetNull(project.FieldOriginURL)
	return u
}

// SetArchivedAt sets the "archived_at" field.
func (u *ProjectUpsert) SetArchivedAt(v time.Time) *ProjectUpsert {
	u.Set(project.FieldArchivedAt, v)
	return u
}

// UpdateArchivedAt sets the "archived_at" field to the value that was provided on create.
func (u *ProjectUpsert) UpdateArchivedAt() *ProjectUpsert {
	u.SetExcluded(project.FieldArchivedAt)
	return u
}

// ClearArchivedAt clears the value of the "archived_at" field.
func (u *ProjectUpsert) ClearArchivedAt() *ProjectUpsert {
	u.SetNull(project.FieldArchivedAt)
	return u
}

// SetLastActiveAt sets the "last_active_at" field.
func (u *ProjectUpsert) SetLastActiveAt(v time.Time) *ProjectUpsert {
	u.Set(project.FieldLastActiveAt, v)
	return u
}

// UpdateLastActiveAt sets the "last_active_at" field to the value that was provided on create.
func (u *ProjectUpsert) UpdateLastActiveAt() *ProjectUpsert {
	u.SetExcluded(project.FieldLastActiveAt)
	return u
}
...
// SetOriginURL sets the "origin_url" field.
func (u *ProjectUpsertOne) SetOriginURL(v string) *ProjectUpsertOne {
	return u.Update(func(s *ProjectUpsert) {
		s.SetOriginURL(v)
	})
}
...
// UpdateOriginURL sets the "origin_url" field to the value that was provided on create.
func (u *ProjectUpsertOne) UpdateOriginURL() *ProjectUpsertOne {
	return u.Update(func(s *ProjectUpsert) {
		s.UpdateOriginURL()
	})
}
...
// ClearOriginURL clears the value of the "origin_url" field.
func (u *ProjectUpsertOne) ClearOriginURL() *ProjectUpsertOne {
	return u.Update(func(s *ProjectUpsert) {
		s.ClearOriginURL()
	})
}
...
// SetArchivedAt sets the "archived_at" field.
func (u *ProjectUpsertOne) SetArchivedAt(v time.Time) *ProjectUpsertOne {
	return u.Update(func(s *ProjectUpsert) {
		s.SetArchivedAt(v)
	})
}
...
// UpdateArchivedAt sets the "archived_at" field to the value that was provided on create.
func (u *ProjectUpsertOne) UpdateArchivedAt() *ProjectUpsertOne {
	return u.Update(func(s *ProjectUpsert) {
		s.UpdateArchivedAt()
	})
}
...
// ClearArchivedAt clears the value of the "archived_at" field.
func (u *ProjectUpsertOne) ClearArchivedAt() *ProjectUpsertOne {
	return u.Update(func(s *ProjectUpsert) {
		s.ClearArchivedAt()
	})
}
...
// SetLastActiveAt sets the "last_active_at" field.
func (u *ProjectUpsertOne) SetLastActiveAt(v time.Time) *ProjectUpsertOne {
	return u.Update(func(s *ProjectUpsert) {
		s.SetLastActiveAt(v)
	})
}
...
// UpdateLastActiveAt sets the "last_active_at" field to the value that was provided on create.
func (u *ProjectUpsertOne) UpdateLastActiveAt() *ProjectUpsertOne {
	return u.Update(func(s *ProjectUpsert) {
...
// SetOriginURL sets the "origin_url" field.
func (u *ProjectUpsertBulk) SetOriginURL(v string) *ProjectUpsertBulk {
	return u.Update(func(s *ProjectUpsert) {
		s.SetOriginURL(v)
	})
}
...
// UpdateOriginURL sets the "origin_url" field to the value that was provided on create.
func (u *ProjectUpsertBulk) UpdateOriginURL() *ProjectUpsertBulk {
	return u.Update(func(s *ProjectUpsert) {
		s.UpdateOriginURL()
	})
}
...
// ClearOriginURL clears the value of the "origin_url" field.
func (u *ProjectUpsertBulk) ClearOriginURL() *ProjectUpsertBulk {
	return u.Update(func(s *ProjectUpsert) {
		s.ClearOriginURL()
	})
}
...
// SetArchivedAt sets the "archived_at" field.
func (u *ProjectUpsertBulk) SetArchivedAt(v time.Time) *ProjectUpsertBulk {
	return u.Update(func(s *ProjectUpsert) {
		s.SetArchivedAt(v)
	})
}
...
// UpdateArchivedAt sets the "archived_at" field to the value that was provided on create.
func (u *ProjectUpsertBulk) UpdateArchivedAt() *ProjectUpsertBulk {
	return u.Update(func(s *ProjectUpsert) {
		s.UpdateArchivedAt()
	})
}
...
// ClearArchivedAt clears the value of the "archived_at" field.
func (u *ProjectUpsertBulk) ClearArchivedAt() *ProjectUpsertBulk {
	return u.Update(func(s *ProjectUpsert) {
		s.ClearArchivedAt()
	})
}
...
// SetLastActiveAt sets the "last_active_at" field.
func (u *ProjectUpsertBulk) SetLastActiveAt(v time.Time) *ProjectUpsertBulk {
	return u.Update(func(s *ProjectUpsert) {
		s.SetLastActiveAt(v)
	})
}
...
// UpdateLastActiveAt sets the "last_active_at" field to the value that was provided on create.
func (u *ProjectUpsertBulk) UpdateLastActiveAt() *ProjectUpsertBulk {
	return u.Update(func(s *ProjectUpsert) {
		s.UpdateLastActiveAt()
	})
}
